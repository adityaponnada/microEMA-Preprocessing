...
uEMAFile <- read.csv("C:/Users/Dharam/Downloads/microEMA/StudyFiles/CombinedData/uema19/combinedData_600sec.csv", header = TRUE, sep = ",")
...
write.csv("C:/Users/Dharam/Downloads/microEMA/StudyFiles/CombinedData/uema19/combinedData_600sec.csv", x = uEMAFile, quote = FALSE, row.names = FALSE, col.names = TRUE, sep = ",")
