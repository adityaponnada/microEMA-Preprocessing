...
write.csv(file = "C:/Users/Dharam/Downloads/microEMA/StudyFiles/CombinedData/uema07/combinedData_60sec.csv", x = countsEMADataFrame, quote = FALSE, row.names = FALSE, col.names = TRUE, sep = ",")
