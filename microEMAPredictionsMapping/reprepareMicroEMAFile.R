...
write.csv(file = "C:/Users/Dharam/Downloads/microEMA/StudyFiles/CombinedData/uema23/mappedPredictions_600.csv", x = testFrame, quote = FALSE, row.names = FALSE, col.names = TRUE, sep = ",")
