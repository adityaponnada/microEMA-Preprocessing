...
# }
# 
# plotJenks(combinedFile$COUNTS_SUM_ANKLE_BEFORE, n = 4, brks.cex = 0.70, top.margin = 10, dist = 5)
# 
# resultsJenks <- plotJenks(combinedFile$COUNTS_SUM_ANKLE_BEFORE, n = 4)

getJenksBreaks(combinedFile$COUNTS_SUM_ANKLE_BEFORE, 5)
